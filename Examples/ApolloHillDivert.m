...
% Boundary Conditions:
System.r0 = [-100;-100;0]; % Initial Position [m]
System.v0 = [0;0;0]; % Initial Velocity [m/s]
System.q0 = eul2quat([0,0,0])'; % Initial Orientation
System.w0 = [0;0;0]; % Initial Rotational Rate [rad/s]
System.rf = [100;100;0]; % Initial Position [m]
...
% Parbolic Hill:
System.HillHeight = 50; % [m]
System.HillWidth = 200; % [m]
System.Padding = 0; % [m]

% Scale:
rs = System.HillHeight*1.5;
ms = System.WetMass;
ts = t;
t = t/ts;
...
System.HillHeight = System.HillHeight/rs;
System.HillWidth = System.HillWidth/rs;
System.Padding = System.Padding/rs;
...
% Initial Guess:
N = 30; % Nodes
rguess = [sqrt(100)*linspace(-10,10,N);sqrt(100)*linspace(-10,10,N);(100-linspace(-10,10,N).^2)]/rs; % Parabolic Guess
InitialGuess.x = [rguess;System.x0(4:end)*linspace(1,0,N) + [System.xf(4:end);System.DPSPropellantMass;System.RCSPropellantMass]*linspace(0,1,N);];%System.x0*linspace(1,0,N) + [System.xf;System.DPSPropellantMass;System.RCSPropellantMass]*linspace(0,1,N);
...
x(14:15,:,:) = x(14:15,:,:)*ms;
u(:,:,:) = u(:,:,:)*ms*rs/ts^2;
System.DPSMaximumThrust = System.DPSMaximumThrust*ms*rs/ts^2;
System.RCSMaximumThrust = System.RCSMaximumThrust*ms*rs/ts^2;
System.HillWidth = System.HillWidth*rs;
System.HillHeight = System.HillHeight*rs;
PlotApolloHillDivert(System,x(:,:,end),u(:,:,end));
...
% Nonconvex Inequality Constraint (s <= 0):
s = [-(x(1)^2+x(2)^2) - System.HillWidth*(x(3)-System.HillHeight-System.Padding)];
